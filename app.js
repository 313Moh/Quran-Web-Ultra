...
const pageContainer = document.getElementById("quran-page-container"); // حاوية الصفحة
...
// ============================================
// إضافة التمرير العمودي بالأسهم
// ============================================
document.addEventListener("keydown", (e) => {
    const scrollAmount = 50; // مقدار التمرير بالبيكسل
    if (!menuOverlay.classList.contains("hidden")) return; // لا نمرر إذا القائمة مفتوحة
    if (e.key === "ArrowDown") {
